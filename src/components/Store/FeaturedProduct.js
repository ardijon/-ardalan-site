  ...
  return (
    <section className="py-16 sm:py-24">
      <div className="max-w-6xl mx-auto px-5 sm:px-6 lg:px-8">
        <div className="relative rounded-[2rem] border border-[var(--color-accent)]/20 bg-gradient-to-br from-[var(--color-accent)]/5 via-[var(--color-bg)] to-[var(--color-tech)]/5 overflow-hidden animate-[fadeUp_0.8s_ease_forwards]">
            ...
            <div className="flex flex-col justify-center">
              ...
              <div className="flex items-center gap-4 mb-6">
                <span className="text-sm text-[var(--color-text)]/50">
                  {locale === 'fa' ? 'پشتیبانی ۶ ماهه رایگان' : '6 months free support'}
                </span>
              </div>
